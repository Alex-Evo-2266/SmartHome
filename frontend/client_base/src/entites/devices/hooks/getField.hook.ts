import { useGetBinaryFieldControl, useGetEnumFieldControl, useGetNumberFieldControl } from "../../../features/Device/hooks/fieldControl.hook"
import { DeviceSchema } from ".."

function getField(device: DeviceSchema | null, nameField: string){
...
export const useGetBinaryField = (device: DeviceSchema | null, nameField: string) => {
...
export const useGetNumberField = (device: DeviceSchema | null, nameField: string) => {
...
export const useGetEnumField = (device: DeviceSchema | null, nameField: string) => {
