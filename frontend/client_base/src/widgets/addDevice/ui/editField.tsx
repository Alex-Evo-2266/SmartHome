        ...
        <FullScrinTemplateDialog header="add field" onHide={onHide} onSave={save}>
            <div style={{marginInline: '16px'}}>
                <Form value={value} changeValue={change} errors={errors}>
                    ...
                    {/* {option.fields_change.unit && <Form.SwitchButtonField name="virtual_field" placeholder="virtual"/>}
                    {option.fields_change.unit && <Form.SwitchButtonField name="read_only" placeholder="read only"/>} */}
                </Form>
            </div>
