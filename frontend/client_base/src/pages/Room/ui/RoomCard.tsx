        ...
        <Card className="room-card" onClick={()=>navigate(`/room/${room.name_room}`)}>
            <Typography type="title-2">{capitalizeFirst(room.name_room)}</Typography>
            {
                ...
                <div className="room-card-bool-indicator-container">
                    <div onClick={clickLight} className={`room-card-bool-indicator ${light_val? "active": ""}`}>
            ...
            }
            {
                ...
                <div className="room-card-bool-indicator-container">
                    <div onClick={clickDecoLight} className={`room-card-bool-indicator ${deco_light_val? "active": ""}`}>
                        <Typography type="title-1">light</Typography>
                    </div>
                </div>
            }
