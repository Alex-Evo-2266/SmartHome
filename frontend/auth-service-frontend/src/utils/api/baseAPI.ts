...
export const baseAPI = async(url:string, method: TypeRequest = TypeRequest.GET, body:Record<string, any> | Record<string, any>[] |undefined | null = undefined, headers:Record<string, any> = {}, file:boolean = false) => {
...
export const APIWitchToken = async(url:string, method: TypeRequest = TypeRequest.GET, body:Record<string, any> | Record<string, any>[] | undefined | null = undefined, token:string | undefined | null, headers:Record<string, any> = {}, file:boolean = false) => {
	if(token){
...
export const requestWithRefrash = async (
	...
	body:Record<string, any> | Record<string, any>[] | undefined | null = undefined, 
