...
Revision ID: 6a25ef53cee1
Revises: 
Create Date: 2023-12-24 18:46:57.741528
...
def upgrade():
    ...
    op.create_table('trigger_action_differentlys',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['trigger'], ['triggers.system_name'], name='fk_trigger_action_differentlys_triggers_system_name_trigger', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('value', sa.String(length=1000), nullable=False),
    sa.Column('trigger', sa.String(length=200), nullable=True),
    sa.ForeignKeyConstraint(['trigger'], ['triggers.system_name'], name='fk_trigger_actions_triggers_system_name_trigger', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('value', sa.String(length=1000), nullable=False),
    sa.Column('trigger', sa.String(length=200), nullable=True),
    sa.ForeignKeyConstraint(['trigger'], ['triggers.system_name'], name='fk_trigger_conditions_triggers_system_name_trigger', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('entity', sa.String(length=300), nullable=False),
    sa.Column('trigger', sa.String(length=200), nullable=True),
    sa.ForeignKeyConstraint(['trigger'], ['triggers.system_name'], name='fk_trigger_entitys_triggers_system_name_trigger', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('trigger_action_differentlys')
