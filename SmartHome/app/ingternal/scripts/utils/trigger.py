import re
from app.ingternal.scripts.enums import TypeEntityInString, TypeEntity, TIME_DAYS, TIME_MONTH, TypeEntityCondition, TypeEntityAction
...
def get_type_entity(str:str):
    if str == TypeEntityInString.DEVICE:
        return TypeEntity.DEVICE
    if str == TypeEntityInString.SERVICE:
        return TypeEntity.SERVICE
...
def trigger_entity_time_day_of_week(str:str | None):
    if not str:
        return None
