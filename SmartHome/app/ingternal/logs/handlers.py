...
handler_room = LogManager("room", level=LOGS_LEVEL)
handler_sender = LogManager("sender", level=LOGS_LEVEL)
handler_listener = LogManager("listener", level=LOGS_LEVEL)
handler_test = LogManager("test", level=LOGS_LEVEL)
handler_loop = LogManager("loop", level=LOGS_LEVEL)