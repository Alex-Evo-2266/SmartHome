from app.ingternal.room.serialize_model.get_room import get_room_all, get_room as get_room_1
from app.ingternal.room.serialize_model.room_config_device import get_room as get_room_2
