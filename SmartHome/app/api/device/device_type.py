...
from app.db.repositories.device.read_type import get_all_type_device, get_type_device, get_type_main_device
from app.db.repositories.device.delete_type import delete_type_device
from app.db.repositories.device.update_type import update_type_device, set_main
from app.schemas.device.add_device_type import AddOrEditDeviceTypeSchema, SetMain
from app.schemas.device.device_type import DeviceTypeSerializeSchema, DeviceTypeResponseSchema, DeviceTypeSerializeResponseSchema
from app.core.entities.device.types.get_types import get_all_types as get_types
