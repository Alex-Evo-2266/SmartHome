from app.schemas.automation.automation import AutomationSchema, TriggerItemSchema
from typing import List, Callable, Optional, Dict, Tuple, Awaitable, TypeVar, Set
from datetime import datetime, timedelta, timezone
from pydantic import BaseModel

from app.db.cache.room.all_rooms import get_cached_room_data
from app.schemas.room.room import RoomDevicesRaw
from app.pkg.logger import MyLogger
from app.core.state.event import DevicePatch
from app.core.state.room_store import RoomDevicePatch
