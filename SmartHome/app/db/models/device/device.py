...
from app.db.ormar.dbormar import base_ormar_config
from typing import Optional, Dict, Union
from app.schemas.device.enums import ReceivedDataFormat, TypeDeviceField, FieldGetDataType, DeviceGetData, DeviceStatusField, StatusDevice, DeviceFieldCategory
...
class DeviceField(ormar.Model):
	...
	name: str = ormar.String(max_length=200)
	category: Optional[DeviceFieldCategory] = ormar.String(max_length=50, nullable=True)
